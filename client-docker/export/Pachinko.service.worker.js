...
/** @type {string} */
const CACHE_VERSION = '1724400112|446738751';
/** @type {string} */
const CACHE_PREFIX = 'Pachinko-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Pachinko.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Pachinko.html","Pachinko.js","Pachinko.offline.html","Pachinko.icon.png","Pachinko.apple-touch-icon.png","Pachinko.worker.js","Pachinko.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Pachinko.wasm","Pachinko.pck"];
